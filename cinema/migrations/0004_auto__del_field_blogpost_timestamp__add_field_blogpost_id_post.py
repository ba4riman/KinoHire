...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlogPost.timestamp'
        db.delete_column('cinema_blogpost', 'timestamp')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'BlogPost.timestamp'
        raise RuntimeError("Cannot reverse this migration. 'BlogPost.timestamp' and its values cannot be restored.")
